...
// appDirectory fileBasedRouting serverComponent useClient useState dynamicExport forceStaticOrDynamic metadata generateMetadata nextFont nextImage useSelector useDispatch storeProvider
import Link from 'next/link'
import type { Metadata } from 'next'
import { Inter } from 'next/font/google'
